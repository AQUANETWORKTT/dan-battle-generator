...
export default function ManagersPage() {
  ...
  function enter(event: React.FormEvent) { event.preventDefault(); if (password !== "1" || !selected) { setError("ACCESS DENIED"); return; } window.location.assign(`/agency/${agency}/managers/${encodeURIComponent(selected.manager_key)}?label=${encodeURIComponent(selected.manager_label)}`); }
