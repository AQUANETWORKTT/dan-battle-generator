...
export default function ManagerAssignmentsPage() {
  ...
  function onDrop(event: React.DragEvent, group: Group) {
    ...
    if (type === "manager" && key) void save({ ...assignments, managerGroups: { ...assignments.managerGroups, [key]: group }, ownerManagers: assignments.ownerManagers.filter((ownerKey) => ownerKey !== key) });
  }
