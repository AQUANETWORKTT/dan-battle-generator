...
type Accent = "yellow" | "sky" | "emerald" | "orange" | "cyan" | "red" | "purple" | "gray";
...
const groups: Array<{ title: string; description: string; accent: Accent; workspaces: Workspace[] }> = [
  ...
  { title: "Creator/Agency Targets", description: "Track creator progress, graduation and mature-creator retention.", accent: "emerald", workspaces: [
    ...
    { href: "/data/focus-target-tracker", number: "23", label: "Priority creators", title: "Focus Target Tracker", description: "Choose specific creators from Team Dan / James and keep their monthly progress together in one focused view.", accent: "emerald" },
  ] },
...
const order = ["Leaderboards", "Creator/Agency Targets", "Creator Analysis", "Battle Data", "Management", "Data Settings", "In Development"];
