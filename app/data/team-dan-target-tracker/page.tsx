...
export default function Page() {
  ...
  const totals = active.reduce((summary, creator) => ({ diamonds: summary.diamonds + creator.diamonds, target: summary.target + creator.t.diamonds, maintenance: summary.maintenance + (creator.maintenance || 0), rankUp: summary.rankUp + (creator.rankUp || 0) }), { diamonds: 0, target: 0, maintenance: 0, rankUp: 0 });
