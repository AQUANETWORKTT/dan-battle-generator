...
const TARGET_LEVELS = [
  { label: "2% TARGET", level: 2, monthlyTotal: 34862854 }, { label: "3% TARGET", level: 3, monthlyTotal: 37353057 }, { label: "4% TARGET", level: 4, monthlyTotal: 39843261 }, { label: "5% TARGET", level: 5, monthlyTotal: 42333465 }, { label: "7% TARGET", level: 7, monthlyTotal: 44823669 }, { label: "8% TARGET", level: 8, monthlyTotal: 47313873 }, { label: "9% TARGET", level: 9, monthlyTotal: 49804076 }, { label: "10% TARGET", level: 10, monthlyTotal: 52294280 }, { label: "11% TARGET", level: 11, monthlyTotal: 54784484 }, { label: "12% TARGET", level: 12, monthlyTotal: 57274688 }, { label: "13% TARGET", level: 13, monthlyTotal: 59764892 }, { label: "14% TARGET", level: 14, monthlyTotal: 62255095 }, { label: "15% TARGET", level: 15, monthlyTotal: 64745299 },
];
...
export default function IncrementalDataTrackingPage() {
  const [day, setDay] = useState(() => Math.min(31, Math.max(1, new Date().getDate() - 1)));
  ...
  const targetRows = useMemo(() => TARGET_LEVELS.map((target) => ({ ...target, dayTarget: Math.round((target.monthlyTotal / 31) * day) })), [day]);
