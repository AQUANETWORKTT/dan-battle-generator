...
export default function BattleNetworkSettingsPage() {
  ...
  async function load() {
    ...
    if (response.ok) { setAgencies(data.agencies || []); setManagerSettings(data.managerSettings || {}); setIncompatibilities(data.incompatibilities || []); setCreatorBlocks(data.creatorBlocks || []); }
